...
#df = read.csv("/Users/anasosman/Downloads/ExperimentOutside/02.csv")
...
outputOffModel <- data.frame (matrix(ncol=3, nrow=0))
colnames(outputOffModel) <- c('rosbagTimestamp','x','y')
